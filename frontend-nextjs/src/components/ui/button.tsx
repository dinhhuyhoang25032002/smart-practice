    ...
    return (
      ...
      >
        {Icon &&
          iconPlacement === "left" &&
          (effect === "expandIcon" ? (
            <div className="w-0 translate-x-[0%] pr-0 opacity-0 transition-all duration-200 group-active:w-5 group-hover:w-5 group-active:translate-x-100 group-hover:translate-x-100 group-hover:pr-2 group-active:pr-2 group-hover:opacity-100 group-active:opacity-100">
              <Icon />
            </div>
          ) : (
            <Icon />
        ...
        {Icon &&
          iconPlacement === "right" &&
          (effect === "expandIcon" ? (
            <div className="w-0 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100 group-active:w-5 group-active:translate-x-0 group-active:pl-2 group-active:opacity-100">
              <Icon />
            </div>
          ) : (
            <Icon />
